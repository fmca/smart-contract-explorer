...
import './original/SirinSmartToken.sol';
...
contract Crowdsale {
    ...
    constructor (uint256 _startTime, uint256 _endTime, uint256 _rate, address payable _wallet, SirinSmartToken _token) public {
